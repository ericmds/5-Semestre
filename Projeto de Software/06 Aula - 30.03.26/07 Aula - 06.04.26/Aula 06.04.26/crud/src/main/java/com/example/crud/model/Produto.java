...
public class Produto {
    ...
    @Id                      // GenerationType.UUID - Cria id's aleatórios, maneira mais segura
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Autoincrement
    private int id;
    @Column(unique=true, nullable=false, length=100) //Não pode repetir, não pode se nulo, tamanho 100
    private String nome;
